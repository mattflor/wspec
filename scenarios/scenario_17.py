...
rejection_probability_species2 = pr_s2 = 0.5
...
parameters = dict(m=m, s=s, pt=pt, pr_s1=pr_s1, pr_s2=pr_s2, pr_t1=pr_t1, pr_t2=pr_t2, intro=intro, threshold=threshold)           # dictionary for storing simulation
...
#!----------------------------------------------------------------------
species_recognition = {'S1': {'all pops': ('A1-B0-C1-D0', pr_s1)}, \
                       'S2': {'all pops': ('A0-B1-C0-D1', pr_s2)}
                      }
...
R_ = IS_ * IP_ * IT_ * IA_ * IB_ * IC_ * ID_ * \
     HMS_AB_ * \
     HMS_AC_ * HMS_BC_ * \
...
#! Locus overview
#!----------------------------------------------------------------------
print metapop.overview(['Alocus', 'Blocus', 'Clocus', 'Dlocus'], ['trait', 'preference'], 'recognition')
