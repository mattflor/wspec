...
#! Background locus D and trait locus (linked)
#!......................................................................
#$ ~    % we need this non-beaking space because the paragraph would otherwise be empty and the paragraph title would not be didplayed
IDT = core.ReproductionWeight(name='inheritance at Dlocus and trait locus', \
                             axes=['female_Dlocus', 'female_trait', \
                                   'male_Dlocus', 'male_trait', \
                                   'offspring_Dlocus', 'offspring_trait'], \
                             config=config, \
                             r=recombination_rate, \
                             unstack_levels=['offspring_Dlocus', 'offspring_trait'], \
                            )
n1 = len(ALLELES[LOCI.index('Dlocus')])
n2 = len(ALLELES[LOCI.index('trait')])
IDT.set( utils.nuclear_inheritance(n1, n2, r) )
IDT_ = IDT.extended()
print IDT
...
- pop. 1 uninfected, pop. 2 Wolbachia-infected
...
- D and T loci are linked (lower recombination)
- rather weak behavioral divergence at mating preference locus: P1 (T1), P2 (T2)
...
startfreqs[0,1,0,1,0,0,0,0] = 1.                   # pop1-A1-B0-C1-D0-T1-P1-W
startfreqs[1,0,1,0,1,1,1,1] = 1.                   # pop2-A0-B1-C0-D1-T2-P2-W
starttime = time.time()
