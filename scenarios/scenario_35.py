...
parameters = dict(m=m, h=h, lCI=l, f=f, t=t, e=e, s=s, pt=pt, rAT=rAT, intro=intro, threshold=threshold)           # dictionary for storing simulation
...
- in males, A1 acts as a suppressor of Wolbachia's mod function
...
startfreqs[1,0,1,1,1,1,1] = 1.                   # pop2-A0-B1-C2-T2-P2-W
starttime = time.time()
