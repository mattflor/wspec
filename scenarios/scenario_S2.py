...
#!======================================================================
desc = """
- 4 populations, all isolated (i.e. no migration):
  in all populations, a neutral trait T1 is fixed;
  in pop.s 1+2, preference P0 (no mating pref.) fixed; in pop.s 3+4, P1 (T1) is fixed
- trait and preference loci may be linked
- in all pop.s at EQ, an adaptive trait T2 is introduced
- in pop.s 2+4, at the same time, a preference P2 (T2) is introduced
- in pop.s 1+3, the same preference P2 (T2) is introduced only after another EQ has been reached
...
startfreqs[1,0,0] = 1.                   # pop2-T1-P0
startfreqs[2,0,1] = 1.                   # pop3-T1-P1
startfreqs[3,0,1] = 1.                   # pop4-T1-P1
starttime = time.time()
...
metapop.introduce_allele('pop2', intro_allele1, intro_freq=intro, advance_generation_count=True)
metapop.introduce_allele('pop2', intro_allele2, intro_freq=intro, advance_generation_count=True)

metapop.introduce_allele('pop3', intro_allele1, intro_freq=intro, advance_generation_count=True)

metapop.introduce_allele('pop4', intro_allele1, intro_freq=intro, advance_generation_count=True)
metapop.introduce_allele('pop4', intro_allele2, intro_freq=intro, advance_generation_count=True)
