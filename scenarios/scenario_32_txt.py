...
parameters = dict(r=r, l=l, f=f, t=t, m=m, s=s, pt=pt, intro=intro, threshold=threshold)           # dictionary for storing simulation
...
print VS
print
print 'Sexual selection (female mating preference)'
print '^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^'
print '''
These weights are frequency-dependent. Their final states can be found
in section `Dynamic weights (final states)`
'''
weights['dynamic_reproduction'] = []
print
print 'Trait preference'
print '----------------------------------------------------------------'
...
print '^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^'
print 
print 'Cytoplasmic incompatibility'
print '----------------------------------------------------------------'
...
print F
print 
print 'Cytotype inheritance (Wolbachia transmission)'
print '----------------------------------------------------------------'
...
print T
print 
print 'Nuclear inheritance'
print '----------------------------------------------------------------'
print 
print 'Trait and preference loci'
print '................................................................'
...
ITP.set( utils.nuclear_inheritance(n1, n2, r) )
ITP_ = ITP.extended()
print ITP
print 
print 'Background locus A'
print '................................................................'
...
print IC
print 
print 'Hybrid male sterility due to B1 mutation'
print '----------------------------------------------------------------'
HMS_AB, HMS_AB_ = core.hms_generator(('A',1), ('B',1), config, h)
print HMS_AB
print
print 'Hybrid male sterility due to C1 and C2 mutation'
print '----------------------------------------------------------------'
...
- trait and preference loci are linked
...
figs.append(fig)
show()
plt.savefig('start_{0}.pdf'.format(snum), orientation='landscape', papertype='a4')
...
print 
print 'Migration-selection equilibrium'
print '^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^'
...
figs.append(fig)
show()
plt.savefig('mig-sel-eq_{0}.pdf'.format(snum), orientation='landscape', papertype='a4')
...
print metapop.overview()
print 
print 'Introduction of preference allele P3'
print '^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^'
intro_allele = 'P3'
...
figs.append(fig)
show()
plt.savefig('final_{0}.pdf'.format(snum), orientation='landscape', papertype='a4')
...
print 
print 'Dynamic weights (final states)'
print '================================================================'
print 
print 'Sexual selection (final)'
print '^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^'
print 
print 'Trait preference (final)'
print '----------------------------------------------------------------'
print TP
...
figs.append(fig)
show()
plt.savefig('dynamics_{0}.pdf'.format(snum), orientation='landscape', papertype='a4')
