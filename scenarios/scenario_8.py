...
#!======================================================================
desc = """
- 2 populations, arranged like stepping stones linked by symmetrical migration
- population 1 representing uninfected; pop.2 Wolbachia-infected (initially)
- a different trait adaptive in each population (T1 in pop.1, T2 in pop.2)
- allele P2 (female preference for trait T2) is introduced at equilibrium in pop.2
- after a new equilibrium has been reached, allele P1 (female preference for trait T1) is introduced in pop.1
