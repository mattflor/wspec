...
parameters = dict(m=m, s=s, pt=pt, pr_t1=pr_t1, pr_t2=pr_t2, intro=intro, threshold=threshold)           # dictionary for storing simulation
...
startfreqs[0,1,0,1,0,0,0] = 1.                   # pop1-A1-B0-C1-D0-T1-P0
startfreqs[1,0,1,0,1,1,0] = 1.                   # pop2-A0-B1-C0-D1-T2-P0
starttime = time.time()
