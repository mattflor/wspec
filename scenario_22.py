...
R_ = CI_ * F_ * T_ * IP_ * IT_ * IA_ * IB_ * IC_ * HMS_AB_ * HMS_BC_
...
- hybrid males are fully sterile due to divergence at several loci (A, B, and C):
  A1-B1 and B1-C1 males are sterile
...
startfreqs[2,0,0,0,2,1,1] = 1.                   # pop3-A0-B1-C0-T3-P2-W
startfreqs[3,0,0,0,3,1,1] = 1.                   # pop4-A0-B1-C0-T4-P2-W
starttime = time.time()
