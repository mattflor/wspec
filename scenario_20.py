...
parameters = dict(m=m, s=s, pt=pt, h=h, intro=intro, threshold=threshold)           # dictionary for storing simulation
...
R_ = IP_ * IT_ * IA_ * IB_ * IC_ * ID_ * HMS_AB_ * HMS_AD_ * HMS_BC_ * HMS_CD_
...
startfreqs[1,1,0,1,0,1,0] = 1.                   # pop2-A1-B0-C1-D0-T2-P1
startfreqs[2,0,1,0,1,2,1] = 1.                   # pop3-A0-B1-C0-D1-T3-P2
startfreqs[3,0,1,0,1,3,1] = 1.                   # pop4-A0-B1-C0-D1-T4-P2
starttime = time.time()
